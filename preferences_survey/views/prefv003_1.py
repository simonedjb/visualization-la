...
layout = html.Div([
    ...
    interface.survey_chart_preference(control.get_view_question_page_view("V003",_page_name),_page_name),
...
def update_body_prefv003_1(input1,chart1,chart2,chart3,chart4,chart5,chart6,chart7,select_chart):
    global _data_cache
    global _page_name
    ...
    _data_cache= [{"field":'user_V003_7',"value":[
                                                  ...
                                                  {"id_chart_04":"06","value":chart4},
                                                  {"id_chart_05":"08","value":chart5},
                                                  {"id_chart_06":"09","value":chart6},
                                                  {"id_chart_07":"10","value":chart7},
