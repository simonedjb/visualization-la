...
def layout(data_cache=[]):
    ...
    return html.Div([
                ...
                interface.survey_chart_preference(control.get_view_question_page_view("V008",_page_name),_page_name,data_cache),
...
@app.callback(
    ...
    [Input('user_cache', 'children'),
     ...
     Input("comments_id_chart_v008_4",'value')])
def update_body_prefv008_2(input1,chart1,chart2,chart3,chart4,chart5,select_chart,comments):
    global _data_cache
    global _page_name
    ...
    _data_cache= [{"field":'user_V008_4',"value":[
                                                  {"field":"chart_03","value":chart1},
                                                  {"field":"chart_06","value":chart2},
                                                  {"field":"chart_07","value":chart3},
                                                  {"field":"chart_09","value":chart4},
                                                  {"field":"chart_11","value":chart5},
                                                  {"field":"preference_chart","value":select_chart},
                                                 ]},
                  {"field":'comments_id_chart_v008_4',"value":comments},
