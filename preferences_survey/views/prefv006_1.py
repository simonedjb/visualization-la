...
def layout(data_cache=[]):
    ...
    return html.Div([
                ...
                interface.survey_chart_preference(control.get_view_question_page_view("V006",_page_name),_page_name,data_cache),
...
@app.callback(
    ...
    [Input('user_cache', 'children'),
     ...
     Input("comments_id_chart_v006_18",'value')])
def update_body_prefv006_1(input1,chart1,chart2,chart3,chart4,select_chart,comments):
    global _data_cache
    global _page_name
    ...
    _data_cache= [{"field":'user_V006_18',"value":[
                                                  ...
                                                  {"field":"chart_06","value":chart3},
                                                  {"field":"chart_10","value":chart4},
                                                  {"field":"preference_chart","value":select_chart},
                                                 ]},
                  {"field":'comments_id_chart_v006_18',"value":comments},
